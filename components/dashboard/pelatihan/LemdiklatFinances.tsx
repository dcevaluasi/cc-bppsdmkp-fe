...
export function LemdiklatFinances({
    isLoadingPendapatanGrafik,
    loadingAnggaran,
    anggaranData,
    pendapatanData
}: LemdiklatFinancesProps) {
    ...
    const renderChart = (data: any[], title: string, isPNBP: boolean = false,) => {
    ...
    return (
        <div>
            {renderChart(anggaranData, "Grafik Realisasi Belanja", false)}
            {renderChart(pendapatanData, "Grafik Capaian PNBP", true)}
        </div>
    )
}
...
import { useGroupByLocations, useKelompokBidangUsahaPerProvinsi, useKelompokBidangUsahaPerSatminkal } from "@/hooks/penyuluhan/useSummaryKelompokDibentukData";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
import { years } from "@/utils/time";
import { KelompokDibentukMap } from "@/components/map/KelompokDibentukMap";
import { usePenyuluhTotal } from "@/hooks/penyuluhan/useSummaryPenyuluhData";
import { StatsKelompok } from "./charts/StatsKelompok";
import SummaryChartsKelompokDibentuk from "./charts/SummaryChartsKelompokDibentuk";
                ...
                <div className="flex flex-col gap-8">
                    {
                        ...
                        </div> : <KelompokDibentukMap kelompokDibentuks={locationsData!} focusCoords={selectedProvinsiCoords} />
                    }


                    <StatsKelompok total={totalData?.total_kelompok_dibentuk ?? 0} title={'Total Kelompok Dibentuk'} />
                    <SummaryChartsKelompokDibentuk tahun={tahun.toString()} triwulan={triwulan.toString()} provinsi={selectedProvinsi} kabupaten={selectedKabupaten} />
...
export default KelompokDibentuk;

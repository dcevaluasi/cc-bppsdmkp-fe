...
import { useGroupByLocations, useKelompokBidangUsahaPerProvinsi, useKelompokBidangUsahaPerSatminkal, useKelompokJumlahPerProvinsi, useKelompokJumlahPerSatminkal, useKelompokKelasPerProvinsi } from "@/hooks/penyuluhan/useSummaryKelompokDisuluhData";

import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
import { years } from "@/utils/time";
import { KelompokDisuluhMap } from "@/components/map/KelompokDisuluhMap";
import { usePenyuluhTotal } from "@/hooks/penyuluhan/useSummaryPenyuluhData";
import { StatsKelompok } from "./charts/StatsKelompok";
import SummaryChartsKelompokDisuluh from "./charts/SummaryChartsKelompokDisuluh";
        ...
        <div className="flex flex-col gap-8">
          {
            ...
            </div> : <KelompokDisuluhMap kelompokDisuluhs={locationsData!} focusCoords={selectedProvinsiCoords} />
          }


          <StatsKelompok total={totalData?.total_kelompok_disuluh ?? 0} title={'Total Kelompok Disuluh'} />
          <SummaryChartsKelompokDisuluh tahun={tahun.toString()} triwulan={triwulan.toString()} provinsi={selectedProvinsi} kabupaten={selectedKabupaten} />
...
export default KelompokDisuluh;

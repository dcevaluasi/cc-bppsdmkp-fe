...
interface SummaryChartsKelompokDitingkatkanProps {
...
export default function SummaryChartsKelompokDitingkatkan({
    tahun,
    triwulan,
    provinsi,
    kabupaten
}: SummaryChartsKelompokDitingkatkanProps) {
    // Queries
    ...
    const { data: bidangUsahaPerSatminkalData } =
        ...
        <div className="flex flex-col gap-6">
            <div className={provinsi != "" ? "w-full flex gap-5" : "space-y-5"}>
                ...
                <Card className="rounded-2xl !bg-slate-900 shadow-lg w-full">
                    <CardHeader>
                        <CardTitle className="text-gray-200">Jumlah Kelompok per Satminkal</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart data={jumlahPerSatminkalData} layout="horizontal" margin={{ left: 40 }}>
                ...
                <Card className="rounded-2xl !bg-slate-900 shadow-lg w-full">
                    <CardHeader>
                        <CardTitle className="text-gray-200">Jumlah Kelompok per Provinsi</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart data={jumlahPerProvinsiData} layout="horizontal" margin={{ left: 40 }}>
                                <CartesianGrid stroke="#334155" strokeDasharray="3 3" />
                                <YAxis type="number" stroke="#94a3b8" />
                ...
                <Card className="rounded-2xl !bg-slate-900 shadow-lg w-full">
                    ...
                    <CardContent>
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart data={kelasPerProvinsiData} layout="horizontal" margin={{ left: 40 }}>
                                <CartesianGrid stroke="#334155" strokeDasharray="3 3" />
                                <YAxis type="number" stroke="#94a3b8" />
                                <XAxis type="category" dataKey="provinsi" stroke="#94a3b8" width={120} />
                                <Tooltip content={<DarkTooltip />} cursor={{ fill: "rgba(255,255,255,0.05)" }} />
                    ...
                    <CardContent>
                        ...
                        >
                            <BarChart
                                ...
                                margin={provinsi == "" ? { left: 120, bottom: 5 } : { top: 20, right: 30, left: 20, bottom: 80 }}
                            >
                                <CartesianGrid stroke="#334155" strokeDasharray="3 3" />
